...
self.addEventListener('fetch', (event) => {
    ...
    // Skip caching for JavaScript modules (app.js, etc.) - always fetch from network
    // This prevents caching issues that cause duplicate function declarations
        ...
        (async () => {
            try {
                ...
                try {
                    ...
                    // Only cache successful responses (but not JS files - already handled above)
