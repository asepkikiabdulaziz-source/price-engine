...
console.log('🚀 Menyiapkan folder deploy untuk Netlify...\n');
...
if (fs.existsSync(DEPLOY_FOLDER)) {
    console.log('   ⚠️  Folder deploy sudah ada, menghapus...');
...
console.log('   ✅ Folder deploy dibuat\n');
...
if (fs.existsSync(netlifyTomlPath)) {
    ...
    console.log(`   ✅ netlify.toml (modified for manual deploy - no build command)\n`);
} else {
...
`;
    ...
    console.log(`   ✅ netlify.toml (created for manual deploy)\n`);
}

console.log(`   📊 Total: ${copiedCount} file berhasil, ${missingCount} file hilang\n`);

// 5. Validasi
if (missingCount > 0) {
    console.error('❌ ERROR: Beberapa file penting tidak ditemukan!');
...
// 6. Summary
console.log('✅ Folder deploy siap!');
console.log(`\n📁 Lokasi: ${path.resolve(DEPLOY_FOLDER)}`);
console.log('\n📋 Langkah selanjutnya:');
